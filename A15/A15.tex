...
\begin{figure}[!ht]\capstart \includegraphics[trim=150 150 150 155,scale=.75]{intro} \caption{Illustration of \AAAB{} at three
...
binary$_{32}$ is preferred, due to its widespread presence in hardware, software, and network stacks. The nomenclature and
parlance used throughout is primarily that of crystallography, borrowing from other disciplines as necessary.

\begin{figure}[!ht]\capstart \includegraphics[trim=25 50 25 0,scale=.55]{cell2} \caption{Left-handed $^1/_2$ unit cell.}
...
\begin{figure}[!ht]\capstart \includegraphics[trim=130 140 80 50,scale=.35]{wp}\includegraphics[trim=130 140 80 50,scale=.35]{ts}
...
\begin{figure}[!hb] \includegraphics[scale=.5]{main} \label{fig-main} \end{figure}

\subsection{ Validation Techniques and Statistical Analysis }\label{validation-techniques-and-statistical-analysis}

\begin{figure}[!hb] \includegraphics[width=.325\textwidth]{histu} \includegraphics[width=.265\textwidth]{hists}
