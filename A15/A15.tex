...
\hypersetup{
  ...
  pdfborder={2 2 2},
  pdfcreator={LaTeX},
  % https://stackoverflow.com/a/41665409
  pdfinfo={CreationDate={D:20231003150000-00'00}},
...
\begin{figure}[!hb]\capstart \includegraphics[scale=.5]{main}\label{fig-main}\end{figure}
...
\includegraphics[width=.26\textwidth]{histb}\includegraphics[width=.265\textwidth]{hists}\includegraphics[width=.325\textwidth]{histu}\caption{Example
