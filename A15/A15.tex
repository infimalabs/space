...
\begin{figure}[!ht] \capstart \includegraphics[trim=130 140 80 50,scale=.35]{wp} \includegraphics[trim=130 140 80
50,scale=.35]{ts} \caption{\TWPh{} (left) and \tTSp{} (right). \label{fig-wp-ts}} \end{figure}
...
\begin{figure}[!hb] \includegraphics[width=.26\textwidth]{histb} \includegraphics[width=.265\textwidth]{hists}
\includegraphics[width=.325\textwidth]{histu} \caption{Example \emph{binary} (left) \emph{stable} (middle) and \emph{unstable}
(right) configurations. \label{fig-hist}} \end{figure}
